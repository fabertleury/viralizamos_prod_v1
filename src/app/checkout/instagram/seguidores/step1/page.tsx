                  ...
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" className="text-pink-600">
                      <g stroke="currentColor" strokeWidth="2" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M17,21 L17,19 C17,16.790861 15.209139,15 13,15 L7,15 C4.790861,15 3,16.790861 3,19 L3,21"></path>
                        <circle cx="10" cy="7" r="4"></circle>
                        <path d="M21,21 L21,19 C20.9973585,17.1770766 19.8375639,15.5857638 18.1,15.13"></path>
                        <path d="M15,3.13 C16.7456738,3.58317263 17.9101379,5.17992511 17.9101379,7 C17.9101379,8.82007489 16.7456738,10.4168274 15,10.87"></path>
                      </g>
                    </svg>
                  </div>
                </div>
