...
export default function Sidebar({ open, setOpen, className = '' }: SidebarProps) {
  const pathname = usePathname();

  return (
    <>
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className={`relative z-50 lg:hidden ${className}`} onClose={setOpen}>
          <Transition.Child
            as={Fragment}
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              <Dialog.Panel className={`relative mr-16 flex w-full max-w-xs flex-1 ${className}`}>
                <Transition.Child
                  as={Fragment}
